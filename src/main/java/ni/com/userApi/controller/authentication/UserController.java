...
public class UserController {
    ...
    @Autowired
    public UserController(UserService userService, GeneratorJwt generatorJwt,
    ...
    public ResponseEntity<?> loginUser(@RequestBody UserDto userDto) throws Exception {
        ...
        return userService.obtenerUsuarioPorEmailClave(usuario.getEmail(), usuario.getClave())
